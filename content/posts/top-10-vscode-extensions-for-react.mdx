...
excerpt: We will be covering 10 essential visual studio code extensions for React developers. These extensions will help you code faster, cleaner and easier.
date: 2022-07-24
category: reviews
tags:
  - vscode
  ...
  - nextjs
coverImage:
  url: https://images.unsplash.com/photo-1607705703571-c5a8695f18f6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80
  alt: Cover Image
  width: 1920
  height: 1080
---
...
<Image
  src="/images/posts/top-10-vscode-extensions-for-react/prettier-code-formatted.gif"
  priority
  width={1000}
  height={314}
...
<Image
  src="/images/posts/top-10-vscode-extensions-for-react/highlight-matching-tag.gif"
  priority
  width={529 * 2}
  height={306 * 2}
...
<Image
  src="/images/posts/top-10-vscode-extensions-for-react/auto-rename-tag.gif"
  priority
  width={1440}
  height={938}
  alt="Auto Rename Tag"
...
<Image
  src="/images/posts/top-10-vscode-extensions-for-react/VSCode-React-Refactor.gif"
  priority
  width={1000}
  height={742}
...
<Image
  src="/images/posts/top-10-vscode-extensions-for-react/npm-Intellisense.gif"
  priority
  width={931}
  height={281}
...
<Image
  src="/images/posts/top-10-vscode-extensions-for-react/change-case.gif"
  priority
  width={931}
  height={281}
  alt="Change Case"
